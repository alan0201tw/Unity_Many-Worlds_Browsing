...
public class Math3d
{
    ...
    public static Rect ClampToDstRect(Rect src, Rect dst)
    {
        src.x = Mathf.Clamp(src.x, 0, dst.width - src.width);
        src.y = Mathf.Clamp(src.y, 0, dst.height - src.height);
        return src;
    }
    ...
    public static bool ClosestPointsOnTwoLines(out Vector3 closestPointLine1, out Vector3 closestPointLine2, Vector3 linePoint1, Vector3 lineVec1, Vector3 linePoint2, Vector3 lineVec2)
    {
        ...
        if (d != 0.0f)
        {
            // diff
            Vector3 r;
            r.x = linePoint1.x - linePoint2.x;
            r.y = linePoint1.y - linePoint2.y;
            r.z = linePoint1.z - linePoint2.z;
            ...
            closestPointLine1.x = linePoint1.x + lineVec1.x * s;
            closestPointLine1.y = linePoint1.y + lineVec1.y * s;
            closestPointLine1.z = linePoint1.z + lineVec1.z * s;

            closestPointLine2.x = linePoint2.x + lineVec2.x * t;
            closestPointLine2.y = linePoint2.y + lineVec2.y * t;
            closestPointLine2.z = linePoint2.z + lineVec2.z * t;
    ...
    public static Vector3 ProjectPointOnLine(Vector3 linePoint, Vector3 lineVec, Vector3 point)
    {
        ...
        linePointToPoint.x = point.x - linePoint.x;
        linePointToPoint.y = point.y - linePoint.y;
        linePointToPoint.z = point.z - linePoint.z;

        float t = linePointToPoint.x * lineVec.x + linePointToPoint.y * lineVec.y + linePointToPoint.z * lineVec.z;
    ...
    {
        Vector3 vector;
        vector.x = linePoint2.x - linePoint1.x;
        vector.y = linePoint2.y - linePoint1.y;
        vector.z = linePoint2.z - linePoint1.z;
    ...
    public static int PointOnWhichSideOfLineSegment(Vector3 linePoint1, Vector3 linePoint2, Vector3 point)
    {
        ...
        Vector3 pointVec;
        pointVec.x = point.x - linePoint1.x;
        pointVec.y = point.y - linePoint1.y;
        pointVec.z = point.z - linePoint1.z;
